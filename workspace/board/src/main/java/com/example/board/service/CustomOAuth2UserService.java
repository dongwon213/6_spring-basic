...
//        String providerId = null;
//
//        // OAuth2 로부터 받은 사용자 정보
//        Map<String, Object> attribute = oAuth2User.getAttributes();
//        providerId = (String) attribute.get("id").toString();
//
//        // 세부적으로 한 번 더 들어가야 한다
//        Map<String, Object> account = (Map<String, Object>)attribute.get("kakao_count");
//
//        // 한번 더 들어가야 한다
//        Map<String, Object> info = (Map<String, Object>)account.get("profile");
//
...
//        loginUser.setProviderId(providerId);
//        loginUser.setProfilePic(profileUrl);
//        loginUser.setProvider(userRequest.getClientRegistration().getRegistrationId()); // OAuth2 공급자의 이동
//
//        UsersVO user = UsersVO.toEntity(loginUser);
//        // DB 저장 밎 업데이트 로직
//        UsersDTO existingUser = usersMapper.findByProviderId(providerId);
//
//        // 우리 어플리케이샨에 가입한 적이 없는 OAuth 계정
//        if (existingUser == null) {
//            // insert
//            usersMapper.saveUser(user);
//        }
